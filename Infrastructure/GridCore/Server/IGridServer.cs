...
namespace GridCore.Server
{
    ...
    public interface IGridServer<T>
    {
        ...
        IGridServer<T> WithPaging(int pageSize, int totalRecord, int maxDisplayedItems);
        ...
        IGridServer<T> WithPaging(int pageSize, int totalRecord,int maxDisplayedItems, string queryStringParameterName);
