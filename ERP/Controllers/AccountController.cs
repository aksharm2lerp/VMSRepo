...
namespace ERP.Controllers
{
    ...
    public class AccountController : SettingsController
    {
        ...
        public AccountController(IRoleAccessStore roleAccessStore, UserManager<UserMasterMetadata> userManager, SignInManager<UserMasterMetadata> signInManager, IEmailService emailService)
        {
            _userManager = userManager;
            _signInManager = signInManager;
            _roleAccessStore = roleAccessStore;
            _emailService = emailService;
            //companyName = _cache[CacheKeys.CompanyName] as string;
        }
        ...
        public async Task<IActionResult> ForgotPassword(ForgotPasswordViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                //send email code --haresh
                var callbackUrl = Url.ActionLink("ResetPassword", "Account",new { code = code });
                MailRequest request = new MailRequest();
                request.Subject = "Reset Password";
                request.Body = $"Please reset your password by clicking here: <a href='{callbackUrl}'>link</a>";
